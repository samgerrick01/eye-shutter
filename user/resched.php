	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				include('../connect.php');
$result = mysql_query("SELECT * FROM reserve WHERE username = '$username' AND status = 'pending' ORDER BY ID DESC");
while($row = mysql_fetch_array($result))
{
			...
			echo '<td width="35%"><center><a href="reschedule.php?sched='.$row["id"].'">Reschedule Reservation</a> |  <a href="deletereserve.php?id='.$row["id"].'" onclick="return confirm(\'Are you sure you want to cancel this reservation?\')">Cancel Reservation</a></td>';
			echo '</tr>';
}
