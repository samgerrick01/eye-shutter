...
include('../connect.php');
$result3 = mysql_query("SELECT * FROM message WHERE id='$message1'");
while($row3 = mysql_fetch_array($result3))
	...
	$status1 = 'Read';
	mysql_query("UPDATE message SET status='$status1' WHERE id='$message1'");
	...
	<p class="meta"><span class="date"></span><span class="posted"></a></span></p>
				...
				<table border="0">
					<tr>
						...
						<td>&nbsp;&nbsp;</td>
						<td style="color:#FFF"><?php echo $from1 ?></td>
					</tr>
					<tr>
						<td></td>
						<td>&nbsp;&nbsp;</td>
					...
					<tr>
						<td></td>
						<td>&nbsp;&nbsp;</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Back to Message List" onclick="window.location='message.php'" style="width:150px;"></td>
					</tr>
