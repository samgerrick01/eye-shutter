		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<!-- content here -->
						...
						<div class="post">
						<img src="images/a1.png" style="height:50px;">
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
													<table class="tftable" border="1" width="90%">
				<thead>
					<th><center><font color="#000">Name</th>
					<th><center><font color="#000">Address</th>
					<th><center><font color="#000">Contact</th>
					<th><center><font color="#000">Email</th>
				...
				include('../connect.php');
$result = mysql_query("SELECT * FROM info ORDER BY name ASC");
while($row = mysql_fetch_array($result))
{
			...
			echo '<td width="35%"><center><a href="message.php?id='.$row["id"].'">Send Message</a> |  <a href="deleteuser.php?id='.$row["id"].'" onclick="return confirm(\'Are you sure you want to delete this item?\')">Delete</a></td>';
			echo '</tr>';
}
