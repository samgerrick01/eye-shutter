		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<table border="0">
					...
					<input type="hidden" name="username" value="<?php echo $from1 ?>">
					<tr>
					...
					<tr>
						<td></td>
						<td>&nbsp;&nbsp;</td>
						<td><input type="submit" value="Submit" name="submit"  style="width:150px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Back to Message List" onclick="window.location='messagelist.php'" style="width:150px;"></td>
					</tr>
